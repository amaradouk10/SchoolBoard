    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-3 dashbordnavbar">
               ...
               <nav>
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="AddStudent"><i class="fas fa-user-circle"></i><span>Ajoutez un élève</span></a></li>
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 mt-5">
                <h3 class="text-center table-prof">Ajout d'élèves</h3>
                <form action="{{ Route('create') }}" method="POST" class="form-group register">
                    ...
                    <div class="input-field mt-3">
                        ...
                        <input type="text" name="classe" placeholder="Classe de l'élève">
                    </div>
                    <div class="input-field mt-3">
                        <i class="fa fa-key "></i>
            ...
            <div class="col-lg-4  col-md-5 col-sm-5">
                <H3 class="table-prof text-center mt-5">Liste des élèves</H3>
                    ...
                    <tbody>
                        @foreach($utilisateurs as $us)
                            <tr>
                                <td>{{ $us->FullName}}</td>
                                <td>{{ $us->classe}}</td>
                                <td><a href=" deletestudent/{{$us->id}}" class="btn btn-danger m-1">Supprimer</a></td>
                            </tr>
                        @endforeach
                    </tbody>
            </div>
